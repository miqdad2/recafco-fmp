...
export class UpdateLocationDto {
  ...
  // null explicitly clears the plant association; undefined means no change
  @IsOptional()
  @IsUUID(4, { message: 'plantId must be a valid UUID v4 or null to remove the plant association' })
  plantId?: string | null;
}
